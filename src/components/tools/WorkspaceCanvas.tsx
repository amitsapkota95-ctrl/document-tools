...
export function WorkspaceCanvas({
  ...
  return (
    <div className="flex min-h-0 flex-1 items-center justify-center p-2 sm:p-4">
      <div
        className={`overflow-y-auto overflow-x-hidden rounded-2xl border border-dashed border-moss/50 bg-cream/90 shadow-eco backdrop-blur-sm ${canvasSurfaceClass}`}
      >
        <div
          ref={innerRef}
